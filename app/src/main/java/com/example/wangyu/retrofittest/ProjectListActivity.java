                        ...
                        public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                            try {
                                ...
                                if (html.contains("登录你的账户")) {
                                    ...
                                    for (int i=0;i<update_detail_list.size();i++){
                                        Log.d("xmlparse", "updatedetail: "+update_detail_list.get(i));
                                    }
                                    ...
                                    BetaList.actionStart(MyApplication.getContext(), versions_name_list, versions_code_list, versions_force_list, versions_publisher_list, versions_date_list, update_detail_list);
            ...
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                try {
                    ...
                    if (html.contains("登录你的账户")) {
                        ...
                        for (int i = 1; i < versionsinfo_list.size(); i = i + 7) {
                            versions_code_list.add(StringUtils.substringBefore(versionsinfo_list.get(i), " "));
                            Log.d("xmlparse", "code: " + versions_code_list);Log.d("xmlparse", "size: " + versions_code_list.size());
